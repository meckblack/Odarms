...
namespace Odarms.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, Restaurant restaurant, FormCollection collectedValues)
        {
            if (ModelState.IsValid)
            {
                
                var user = new ApplicationUser { UserName = restaurant.ContactEmail, Email = restaurant.ContactEmail };
                var result = await UserManager.CreateAsync(user, restaurant.ContactEmail);
                if (result.Succeeded)
                {
